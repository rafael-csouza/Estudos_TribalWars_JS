    ...
    setInterval(function () {
      ...
      if (buildingObject.buildingQueue.length !== 0) {
        ...
        try {
          woodCost = parseInt(
            document
              .querySelector('#main_buildrow_' + building + ' > .cost_wood')
              .getAttribute('data-cost'),
          );
          stoneCost = parseInt(
            document
              .querySelector('#main_buildrow_' + building + ' > .cost_stone')
              .getAttribute('data-cost'),
          );
          ironCost = parseInt(
            document
              .querySelector('#main_buildrow_' + building + ' > .cost_iron')
              .getAttribute('data-cost'),
          );
        } catch (e) {
